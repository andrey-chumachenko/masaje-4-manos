...
const SERVICE_ICONS: ReactNode[] = [
  <svg key="hand" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  <svg key="fire" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.468 5.99 5.99 0 0 0-1.925 3.547 5.975 5.975 0 0 1-2.133-1.001A3.75 3.75 0 0 0 12 18Z" />
  </svg>,
  <svg key="sparkles" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 overflow-hidden rounded-[2rem] bg-white shadow-lg shadow-gold-100/40 lg:grid lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="bg-gradient-to-br from-gold-50 to-cream-100 p-8 md:p-10">
            ...
            <p className="mt-2 text-sm font-medium text-gold-400">{t.services.items[0].duration}</p>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {t.services.items.map((servicio, index) => (
            <div
              key={servicio.title}
